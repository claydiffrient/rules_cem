...
# By default all these toolchains are registered by the cem_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:cem_toolchain",
    toolchain_type = "@com_claydiffrient_rules_cem//cem:toolchain_type",
)
""".format(
            platform = platform,
